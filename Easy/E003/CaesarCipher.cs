...
namespace E003
{
    class CaesarCipher
    {
        public static int ioStyle = 0, cipherOrDecipher = 0, offPut;
        ...
        public static void Main(String[] args)
        {
            ...
            cipherOrDecipher = Convert.ToInt32(Console.ReadLine());
        ...
        public static void TextFileInput()
        {
            ...
            else offPut = (-1) * Convert.ToInt32(Console.ReadLine());
